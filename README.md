...
| [prime-gap-admissibility](https://github.com/jaredwilder/prime-gap-admissibility) | Recovered **eleven original Lean modules** for finite residue-admissibility counting, with a clean pinned GitHub Actions `lake build` replay. This is a formal finite-residue program; no asymptotic prime-gap theorem is claimed, and the universal permutation/bijection boundary remains open. |
| [sums-three-cubes-114](https://github.com/jaredwilder/sums-three-cubes-114) | Recovered original Lean source for the modular program around **a³+b³+c³=114**, including the mod-9/mod-7 ingredients and the exact mod-7 one-zero-coordinate theorem. The equation remains open; the mod-21 search layer is written/computational, and the historical PARI logs have not been recovered. |
...
| Prime-gap admissibility | [prime-gap-admissibility](https://github.com/jaredwilder/prime-gap-admissibility) | Recovered finite residue-admissibility Lean program with a clean pinned rebuild; no asymptotic prime-gap theorem and no universal permutation/bijection theorem claimed. |
| Sums of three cubes: 114 | [sums-three-cubes-114](https://github.com/jaredwilder/sums-three-cubes-114) | Recovered modular Lean core and finite-search history for `a³+b³+c³=114`; the Diophantine equation remains open and historical PARI outputs remain unrecovered. |
...
| [ck-sequences](https://github.com/jaredwilder/ck-sequences) | **84 exact optimal values of `C_k(N)`** across `k=3,4,5`: `C3` exact on `N=30..55`, `C4` on `N=1..34`, and `C5` on `N=1..24`. Every listed value has solver status **OPTIMAL** and an explicitly checked witness; 25 values extend the original 59-row release. |
